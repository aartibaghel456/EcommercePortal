...
const CategoryProduct =() =>{
    ...
    useEffect(() => {
        let mounted = true;
        getCategoryProductList().then(function (response) {
          // handle success
          if(mounted) {
                    ...
                    <div class="row">
                        <div class="col-lg-9 order-1 order-lg-2">
                            <div class="single-banner shop-page-banner">
                                <a href="#">
                                    <img src="/assets/image/bg-banner/2.jpg" alt="Li's Static Banner"/>
                                </a>
                            </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            ...
                                                            <img src={`/assets/image/upload/${item.image_url}`} alt="product image" />
                                                            </a>
                                                            ...
                                                            <div class="product_desc_info">
                                                                <div class="product-review">
                                                                    <h5 class="manufacturer">
                                                                        <a href={`/products-details/${item.id}`}>Graphic Corner</a>
                                                                    </h5>
