...
const OrderDetails=() =>{
  ...
  useEffect(() => {
    let mounted = true;
    getOrderDetailsList().then(function (response) {
      // handle success
      if(mounted) {
  ...
  const getOrderDetailsList = ()=>{
    return axios.get('http://localhost:5000/orderdetails/:id');
                    ...
                    <table class="table datatable dataTable-table">
                      <thead>
                        <tr>
                          ...
                          <th scope="col" data-sortable="" >
                            <a href="#" class="dataTable-sorter">No. of Product</a>
                          </th>
                          <th scope="col" data-sortable="" >
